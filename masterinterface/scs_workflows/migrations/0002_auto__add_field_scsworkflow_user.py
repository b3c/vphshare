...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'scsWorkflow.user'
        db.add_column('scs_workflows_scsworkflow', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'scsWorkflow.user'
        db.delete_column('scs_workflows_scsworkflow', 'user_id')
