...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'scsWorkflow.description'
        db.alter_column('scs_workflows_scsworkflow', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'scsWorkflow.description'
        db.alter_column('scs_workflows_scsworkflow', 'description', self.gf('django.db.models.fields.TextField')(null=True))
