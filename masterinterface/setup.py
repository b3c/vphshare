...
METADATA = dict(
    ...
    install_requires=['django<=1.4.5', 'oauth2==1.5.167', 'python_openid==2.2', 'django-social-auth==0.6.9', 'suds==0.4', 'pysimplesoap==1.05', 'django-piston==0.2.3','M2Crypto==0.21.1','pycrypto==2.6','mod-auth-library', 'requests==0.14.2', 'lxml==2.3.6', 'ordereddict==1.1'],
