...
METADATA = dict(
    ...
    install_requires=['django<=1.4.5', 'oauth2==1.5.167', 'python_openid==2.2', 'django-social-auth==0.6.9', 'suds', 'pysimplesoap', 'django-piston','M2Crypto','pycrypto','mod-auth-library', 'requests', 'lxml==2.3.6', 'ordereddict==1.1'],
