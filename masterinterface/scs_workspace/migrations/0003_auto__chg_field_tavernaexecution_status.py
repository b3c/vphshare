...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TavernaExecution.status'
        db.alter_column('scs_workspace_tavernaexecution', 'status', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'TavernaExecution.status'
        db.alter_column('scs_workspace_tavernaexecution', 'status', self.gf('django.db.models.fields.CharField')(max_length=25))
