...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TavernaExecution.creation_datetime'
        db.alter_column('scs_workspace_tavernaexecution', 'creation_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TavernaExecution.creation_datetime'
        db.alter_column('scs_workspace_tavernaexecution', 'creation_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
    ...
    models = {
        ...
        'scs_workspace.tavernaexecution': {
            ...
            'creation_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
