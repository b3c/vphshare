...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TavernaExecution.taverna_atomic_id'
        db.add_column('scs_workspace_tavernaexecution', 'taverna_atomic_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TavernaExecution.taverna_atomic_id'
        db.delete_column('scs_workspace_tavernaexecution', 'taverna_atomic_id')
