...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TavernaExecution.task_id'
        db.add_column('scs_workspace_tavernaexecution', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=80, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TavernaExecution.task_id'
        db.delete_column('scs_workspace_tavernaexecution', 'task_id')
