...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstitutionPortal.welcome'
        db.add_column('scs_groups_institutionportal', 'welcome',
                      self.gf('django.db.models.fields.CharField')(default='Welcome to our vph-share institutional portal', max_length=200),
                      keep_default=False)

        # Adding field 'InstitutionPortal.description'
        db.add_column('scs_groups_institutionportal', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'InstitutionPortal.header_logo'
        db.add_column('scs_groups_institutionportal', 'header_logo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'InstitutionPortal.carusel_img'
        db.add_column('scs_groups_institutionportal', 'carusel_img',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstitutionPortal.welcome'
        db.delete_column('scs_groups_institutionportal', 'welcome')

        # Deleting field 'InstitutionPortal.description'
        db.delete_column('scs_groups_institutionportal', 'description')

        # Deleting field 'InstitutionPortal.header_logo'
        db.delete_column('scs_groups_institutionportal', 'header_logo')

        # Deleting field 'InstitutionPortal.carusel_img'
        db.delete_column('scs_groups_institutionportal', 'carusel_img')
    ...
    models = {
        ...
        'scs_groups.institutionportal': {
            ...
            'carusel_img': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'header_background': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'header_logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            ...
            'welcome': ('django.db.models.fields.CharField', [], {'default': "'Welcome to our vph-share institutional portal'", 'max_length': '200'})
        },
        'scs_groups.study': {
