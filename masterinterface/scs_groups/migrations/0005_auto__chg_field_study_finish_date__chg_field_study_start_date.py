...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Study.finish_date'
        db.alter_column('scs_groups_study', 'finish_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Study.start_date'
        db.alter_column('scs_groups_study', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Study.finish_date'
        db.alter_column('scs_groups_study', 'finish_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 7, 2, 0, 0)))

        # Changing field 'Study.start_date'
        db.alter_column('scs_groups_study', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 7, 2, 0, 0)))
