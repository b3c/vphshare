...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'Query'
        db.create_table('scs_search_query', (
        ...
        db.send_create_signal('scs_search', ['Query'])

        # Adding M2M table for field user on 'Query'
        db.create_table('scs_search_query_user', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('query', models.ForeignKey(orm['scs_search.query'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('scs_search_query_user', ['query_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'Query'
        db.delete_table('scs_search_query')

        # Removing M2M table for field user on 'Query'
        db.delete_table('scs_search_query_user')
    ...
    models = {
        ...
        'scs_search.query': {
            ...
            'user': (
            'django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'})
        }
    }

    complete_apps = ['scs_search']