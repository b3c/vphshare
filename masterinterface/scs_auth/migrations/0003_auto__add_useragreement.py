...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scs_auth_useragreement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('cookies', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('privacy', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
        ))
        db.send_create_signal('scs_auth', ['UserAgreement'])


    def backwards(self, orm):
        # Deleting model 'UserAgreement'
        db.delete_table('scs_auth_useragreement')
    ...
    models = {
        ...
        'scs_auth.useragreement': {
            'Meta': {'object_name': 'UserAgreement'},
            'cookies': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
